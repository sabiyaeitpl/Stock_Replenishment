...
class ExcelEmpExReport implements FromCollection, WithHeadings
{
     ...
     */
    protected $emp_ex_data;
    public function __construct($emp_ex_data)
    {
        $this->emp_ex_data = $emp_ex_data;
    }
    ...
    public function collection()
    {
        ...
        $record_rs = Employee::select('employees.*', 'employee_pay_structures.*', 'group_name_details.group_name', 'bank_masters.master_bank_name')
                        ...
                        ->where('employees.emp_status', '=', $this->emp_ex_data)
                        //->where('employees.emp_group_name', $this->emp_class_data)
