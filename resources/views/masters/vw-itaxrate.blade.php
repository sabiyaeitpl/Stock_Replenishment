    ...
    <div class="animated fadeIn">
        <div class="row" style="border:none;">
            <div class="col-md-6">
                ...
                <h5 class="card-title">Add Itax Rate</h5>
            </div>
            <div class="col-md-6">
                ...
                <span class="right-brd" style="padding-right:15x;">
                    <ul class="">
                        ...
                        <li>/</li>
                        <li><a href="{{ url('masters/bonus-rate') }}">Itax Rate List</a></li>

                        <li>/</li>
                        <li class="active">Add Itax Rate</li>
            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ url('masters/save-itax-rate') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" id="effective_from" name="effective_from" required
                                        class="form-control"
                                        value="<?php if(!empty($gpf_details->effectiveFfrom)){ echo $gpf_details->effective_from; }  ?>"
                                        required>

                                    @if ($errors->has('effectiveFfrom'))
                                    <div class="error" style="color:red;">{{ $errors->first('effectiveFfrom') }}
                                    </div>
                                    @endif
                                </div>
