                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        <div class="card">
                                ...
                                <div class="aply-lv">
								<a href="{{ url('masters/add-designation') }}" class="btn btn-default">Add Designation Master <i class="fa fa-plus"></i></a>
							</div>
								</div>
									...
									@foreach($designation_rs as $designation)
                                        <tr>
                                            ...
                                            <td>{{ $designation->designation_name }}</td>
                                             <td><a href="{{url('masters/edit-designation')}}/{{$designation->id}}"><i class="ti-pencil-alt"></i></a>
