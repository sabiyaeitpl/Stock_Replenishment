            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ url('masters/save-bank') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="branch_name" name="branch_name" class="form-control" value="{{ (isset($bankdetails[0]['branch_name']) && !empty($bankdetails[0]['branch_name']))?$bankdetails[0]['branch_name']:old('branch_name')}}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input required type="text" id="ifsc_code" name="ifsc_code" class="form-control" value="{{ (isset($bankdetails[0]['ifsc_code']) && !empty($bankdetails[0]['ifsc_code']))?$bankdetails[0]['ifsc_code']:old('ifsc_code')}}">
