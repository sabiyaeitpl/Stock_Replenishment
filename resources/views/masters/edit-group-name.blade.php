...
<div class="content">
    ...
    <div class="row" style="border:none;">
            <div class="col-md-6">       
            <h5 class="card-title">Edit Class Name</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li>/</li>
                                <li class="active">Edit Class Name</li>
            ...
            <div class="main-card">
                <div class="card">
                    <!-- <div class="card-header">
                        <strong>Edit Education Master</strong>
                    </div> -->
                    <div class="card-body card-block">

                        <form action="{{ url('masters/update-group-name') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="group_name" name="group_name" class="form-control" value="{{ $group->group_name }}">
