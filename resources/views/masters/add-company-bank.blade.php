...
@section('content')
        ...
        <div class="content">
            ...
            <div class="col-md-6">       
            <h5 class="card-title"><?php if(empty($bankdetails)){ ?>Add <?php }else{ ?>Edit <?php } ?> Bank Master</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li>/</li>
								<li><a href="#">Company Bank Master</a></li>
								<li>/</li>
                                <li class="active"><?php if(empty($bankdetails)){ ?>Add <?php }else{ ?>Edit <?php } ?> Bank Master</li>
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        <div class="card">
                            ...
                            <strong><?php if(empty($bankdetails)){ ?>Add <?php }else{ ?>Edit <?php } ?> Bank Master</strong>

                            </div> -->
                            <div class="card-body card-block">
                            <form action="{{ url('masters/save-companybank') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
									...
									<div class="row form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="financial_year" class="form-control" <?php if(!empty($bankdetails['id'])){ echo "disabled";} ?>>
                                    ...
                                    <div class="col-md-4">
                                        <label class=" form-control-label">Account Code <span>(*)</span></label>

                                        <select name="account_code" id="account_code"  class="form-control"  <?php if(!empty($bankdetails['id'])){ echo "disabled";} ?>>
                                         <option value="07/003/001" <?php if(!empty($bankdetails['id'])){ if( $bankdetails['account_code'] == "07/003/001"){  echo "selected"; } } ?>>
                                            In Current Accounts</option>
                                           <option value="07/003/003" <?php if(!empty($bankdetails['id'])){ if( $bankdetails['account_code'] == "07/003/003"){  echo "selected"; } } ?>>
                                            In Savings Accounts
                                     </option>
                                </select>

                                    @if ($errors->has('account_code'))
                                        <div class="error" style="color:red;">{{ $errors->first('account_code') }}</div>
                                    @endif
                                </div>
									</div>
