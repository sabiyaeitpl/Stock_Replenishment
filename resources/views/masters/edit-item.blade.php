...
<div class="col-md-6">
      ...
      <div class="row">
        <div class="main-card">
          <div class="card">
            <!-- <div class="card-header"><strong class="card-title"><img src=" " alt="">Edit Item</strong></div> -->
            <div class="card-body card-block">
              <form action="{{ url('masters/update-item') }}" method="post" enctype="multipart/form-data" style="padding:2% 5%;">
                ...
                <div class="lv-due" style="border:none;">
                  ...
                  <div class="row form-group lv-due-body">
                    <div class="col-md-4">
                      ...
                      <input type="text" class="form-control" name="item_code"  required value="<?php if(!empty($item->item_code)){ echo $item->item_code; } ?>">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="text" class="form-control" id="cname" required name="name" value="<?php if(!empty($item->name)){ echo $item->name; } ?>" >
                       @if ($errors->has('name'))
                    ...
                    <label>Category</label>
                      <select class="form-control" id="category_id" name="c_id" required onchange="selectSubCategory()" >
                    ...
                    <input type="number" class="form-control"  required name="min_stock" value="<?php if(!empty($item->min_stock)){ echo $item->min_stock; } ?>">
                    ...
                    <input type="number" class="form-control" required name="max_stock" value="<?php if(!empty($item->max_stock)){ echo $item->max_stock; } ?>">
