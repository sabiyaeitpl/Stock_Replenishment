...
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active"> Add New Religion Master</li>
                    ...
                    <div class="main-card">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <form action="{{ url('masters/save-new-religion') }}" method="post" enctype="multipart/form-data">
...
<input type="text" class="form-control" required id="reli_name" name="rel_name" value="<?php if(app('request')->input('id')){  echo $getRel[0]->religion_name;   }  ?>{{ old('reli_name') }}">
