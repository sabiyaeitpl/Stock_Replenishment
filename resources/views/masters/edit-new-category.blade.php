...
<div class="col-md-6">
        ...
        <div class="row">
            <div class="main-card">
                <div class="card">
                    <!-- <div class="card-header"><strong class="card-title"><img src=" " alt="">Edit New Category</strong></div> -->
                    <div class="card-body card-block">
                        <form action="{{ url('masters/update-category') }}" method="post" enctype="multipart/form-data" style="padding:2% 5%;">
                            ...
                            <div class="lv-due" style="border:none;">
                                ...
                                <div class="row form-group lv-due-body">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" required class="form-control" name="cat_code" value="<?php if (!empty($category->cat_code)) {
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" required class="form-control" name="cat_name" value="<?php if (!empty($category->cat_name)) {
