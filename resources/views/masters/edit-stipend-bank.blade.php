            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ url('masters/update-stipendbank') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="opening_balance" name="opening_balance" class="form-control" value="{{ (isset($bankdetails[0]['opening_balance']) && !empty($bankdetails[0]['opening_balance']))?$bankdetails[0]['opening_balance']:old('opening_balance')}}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="financial_year" name="financial_year" class="form-control" value="{{ (isset($bankdetails[0]['financial_year']) && !empty($bankdetails[0]['financial_year']))?$bankdetails[0]['financial_year']:old('financial_year')}}">
