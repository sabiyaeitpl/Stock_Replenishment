...
@section('content')
 ...
 <!-- Content -->
        <div class="content">
            ...
            <h5 class="card-title">Edit Bonus Rate</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active">Edit Bonus Rate</li>
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        <div class="card">
                            ...
                            <form action="{{ url('masters/update-bonus-rate') }}" method="post" enctype="multipart/form-data">
