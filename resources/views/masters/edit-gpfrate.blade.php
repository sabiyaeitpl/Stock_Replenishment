...
@section('content')
 ...
 <!-- Content -->
        <div class="content">
            ...
            <h5 class="card-title">Edit GPF Rate List</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active">Edit GPF Rate List</li>
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        <div class="card">
                            ...
                            <form action="{{ url('masters/update-gpf-rate') }}" method="post" enctype="multipart/form-data">
