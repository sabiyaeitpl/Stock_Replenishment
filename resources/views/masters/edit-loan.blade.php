...
@section('content')
 ...
 <!-- Content -->
        <div class="content">
            ...
            <div class="col-md-6">       
            <h5 class="card-title"><?php if(empty($loan_details->id)){ ?>Add <?php } ?>Loan</a></h5>      
</div>
<div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="main-card">
                        <div class="card">
                            ...
                            <form action="{{ url('masters/update-loandetail') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        <label class=" form-control-label">Loan Type<span>(*)</span></label>
                                         <input type="text" name="loan_type" required class="form-control" value="<?php if(!empty($loan_details->loan_type)){ echo $loan_details->loan_type; }  ?>" required>
