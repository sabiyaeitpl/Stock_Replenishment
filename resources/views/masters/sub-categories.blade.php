                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
                            ...
                            <div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('masters/add-sub-category') }}" class="btn btn-default">Add New Sub Category <i class="fa fa-plus"></i></a>
							</div>
                            </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td><a href='{{url("masters/edit-sub-category/$subcategory->id")}}'><i class="ti-pencil-alt"></i></a>
												</td>
                                        </tr>
                                        @endforeach                                       
                                    </tbody>
