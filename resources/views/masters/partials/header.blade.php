            ...
            <a id="menuToggle" class="menutoggle"><i class="fa fa-bars"></i></a>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <a title="Logout" style="display: block;overflow: hidden;float:left;padding: 25px 15px 0 0;" class="home" href="{{url('logout')}}"><img style="width:25px;" src="{{ asset('images/logout.png') }}" alt="Logo"></a>
