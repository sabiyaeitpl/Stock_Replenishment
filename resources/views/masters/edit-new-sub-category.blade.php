...
<div class="content">
  ...
  <div class="row" style="border:none;">
            <div class="col-md-6">       
            <h5 class="card-title"> Edit Sub Catagory</h5>      
</div>
<div class="col-md-6">
                ...
                <li class="active"><a href="#">Sub Catagory</a></li>
                                ...
                                <li>/</li>
                                <li class="active">Edit Sub Catagory</li>
      ...
      <div class="main-card">
        <div class="card">
          ...
          <div class="card-body card-block">
            <form action="{{ url('masters/update-sub-category') }}" method="post" enctype="multipart/form-data" style="padding:2% 5%;">
              ...
              <div class="lv-due" style="border:none;">
                ...
                <div class="row form-group lv-due-body">
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" required name="sub_cat_code" value="<?php if (!empty($subcategory->sub_cat_code)) { echo $subcategory->sub_cat_code; } ?>">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" required name="sub_cat_name" value="<?php if (!empty($subcategory->sub_cat_name)) {echo $subcategory->sub_cat_name;} ?>">
