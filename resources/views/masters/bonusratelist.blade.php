...
<div class="content">
    ...
    <div class="animated fadeIn">
        <div class="row" style="border:none;">
            <div class="col-md-6">
                <h5 class="card-title">Bonus Rate List</h5>
            </div>
            <div class="col-md-6">
                ...
                <span class="right-brd" style="padding-right:15x;">
                    <ul class="">
                        ...
                        <li>/</li>
                        <li class="active">Bonus Rate List</li>
                    </ul>
                </span>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="aply-lv" style="padding-right: 17px;margin-bottom:15px;">
                            <a href="{{ url('masters/add-bonus-rate') }}" class="btn btn-default">Add New Bonus Rate <i class="fa fa-plus"></i></a>
                        </div>
                        ...
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href='{{url("masters/edit-bonus-rate/$gpflisting->id")}}'><i
