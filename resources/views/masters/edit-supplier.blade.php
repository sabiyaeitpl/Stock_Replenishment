...
<div class="col-md-6">
                ...
                <li class="active"><a href="#">Supplier</a></li>
                                ...
                                <li>/</li>
                                <li class="active">Edi Supplier</li>
    ...
    <div class="row">
      <div class="main-card">
        <div class="card">
          <!-- <div class="card-header"><strong class="card-title">Edit Supplier</strong></div> -->
          <div class="card-body card-block">
            <form action="{{ url('masters/update-supplier') }}" method="post" enctype="multipart/form-data" style="padding:2% 5%;">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <input type="hidden" id="supplier_id" name="id" value="<?php echo $supplier->id; ?>" />
                ...
                <div class="bef-ship" style="">
                  ...
                  <div class="row form-group lv-due-body" style="border-bottom: 1px solid #ddd; padding-bottom:25px;">
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="text" class="form-control" name="supplier_code" id="supplier_code" value="<?php if (!empty($supplier->supplier_code)) {
