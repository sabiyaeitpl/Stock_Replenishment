...
<div class="content">
    ...
    <div class="row" style="border:none;">
            <div class="col-md-6">       
            <h5 class="card-title">Add Employee Pay Head Link Master</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active">Add Employee Pay Head Link Master</li>
                            </ul>
                        </span>
</div>
</div>
            ...
            <div class="main-card">
                <div class="card">
                    <!-- <div class="card-header">
                        <strong>Add Employee Pay Head Link Master</strong>
                    </div> -->
                    <div class="card-body card-block">

                        <form action="{{ url('masters/save-emp-pay-head-link') }}" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div class="row form-group">
                                <div class="col-md-4">
                                    <label class=" form-control-label">Pay Deduction ID <span>(*)</span></label>
                                    <input type="text" required id="pay_deduct_id" name="pay_deduct_id" class="form-control" value="">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="emp_name" required>
                                        ...
                                        <option value='{{ $emp->id }}'>{{ $emp->emp_fname }} {{ $emp->emp_mname }} {{ $emp->emp_lname }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="pay_deduct_head" name="pay_deduct_head" class="form-control" value="">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="pay_type" name="pay_type" class="form-control" value="">
                            ...
                            <div class="row form-group">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="min_limit" name="min_limit" class="form-control" value="">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="max_limit" name="max_limit" class="form-control" value="">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" required id="deduct_order" name="deduct_order" class="form-control" value="">
