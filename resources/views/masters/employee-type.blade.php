...
<div class="col-md-6">
            ...
            <form action="{{ url('masters/save-employee-type') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    <input type="text" id="employee_type_name" required name="employee_type_name" class="form-control" value="<?php if(!empty($employee_type->employee_type_name)){ echo $employee_type->employee_type_name;}?>">
