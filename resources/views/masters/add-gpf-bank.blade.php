...
@section('content')
        ...
        <div class="content">
            ...
            <div class="col-md-6">       
            <h5 class="card-title">Add GPF Bank Master</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li>/</li>
                                <li class="active">Add GPF Bank Master</li>
                ...
                <div class="row">
                    ...
                    <div class="main-card"> 
                        <div class="card">
                            ...
                            <form action="{{ url('masters/save-gpfbank') }}" method="post" enctype="multipart/form-data">
