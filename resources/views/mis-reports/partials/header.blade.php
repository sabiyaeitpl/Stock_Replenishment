            ...
            <div class="hd-name">
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a style="display: block;overflow: hidden;float:left;padding: 20px 15px 0 0;" class="home" href="{{url('dashboard')}}"><img style="width:32px;" src="{{ asset('images/home.png') }}" alt="Logo"></a>
                        
                        <a title="Logout" style="display: block;overflow: hidden;float:left;padding: 25px 15px 0 0;" class="home" href="{{url('logout')}}"><i class="fa fa-power-off" aria-hidden="true" style="color: #e85e27;font-size: 24px;"></i></a>
