...
@section('title')
BELLEVUE - View Income Expenditure Summary Report
@endsection
  	...
  	<div class="content">
	    ...
	    <div class="animated fadeIn">
	      ...
	      <div class="row">
	        <div class="main-card">
	          <div class="card">
	            <div class="card-header"> <strong>Establishment Payment & Receipt</strong> </div>
	            ...
	            <form action="{{ url('establishment-receipt-payment') }}" method="post" style="width: 70%;margin: 0 auto;" target="_blank">
