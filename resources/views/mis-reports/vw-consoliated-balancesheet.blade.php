  	...
  	<div class="content">
	    ...
	    <div class="animated fadeIn">
	      ...
	      <div class="row">
	        <div class="main-card">
	          <div class="card">
	            <div class="card-header"> <strong>Consoliated BalanceSheet</strong> </div>
	            ...
	            <form action="{{ url('consoliated-balancesheet') }}" method="post" style="width: 70%;margin: 0 auto;" target="_blank">
