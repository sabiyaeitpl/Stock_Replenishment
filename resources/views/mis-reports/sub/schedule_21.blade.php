...
<html lang="en">
<head>
  <title>BELLEVUE | Schedule 21 | Other Expenses</title>
  <meta charset="utf-8">
...
<table class="comp-det" style="width:100%;">
		<tr>
			...
			<td>
				...
				<h4>Schedule 21 - Other Expenses</h4>
				</div>
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		...
		<tbody>
			<tr>
				<td style="padding:3px;">a) Provision for bad doubtful debts/advances</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">0</td>
			</tr>

			<tr>
				<td style="padding:3px;">b) Irrecoverable balances written-off</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;">c) Grants/Subsidies to other institutions/organizations</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;">d) Other (Specify)</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
