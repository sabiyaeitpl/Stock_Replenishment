...
<table class="comp-det" style="width:100%;">
		<tr>
			...
			<td>
				...
				<h4>Schedule 22 - Prior Period Expenses</h4>
				</div>
...
<table border="1" style="width:100%;border-collapse:collapse;">
	<thead>
		...
		<tbody>
			<tr>
				<td style="padding:3px;">1) establishment Expenses</td>
				<td style="padding:3px;" class="right">0</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>

			<tr>
				<td style="padding:3px;">2) Academic Expenses</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;">3) Administrative Expenses</td>
				<td style="padding:3px;" class="right">0</td>
				<td style="padding:3px;" class="right">0</td>
			</tr>
			<tr>
				<td style="padding:3px;">4) Tranportation Expenses</td>
				<td style="padding:3px;" class="right">0</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;">5) Repair &amp; Maintenances</td>
				<td style="padding:3px;" class="right">0</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td style="padding:3px;">6) Other Expenses</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
				<td class="sub">a) Auditors Remuneration</td>
				<td style="padding:3px;" class="right">-</td>
				<td style="padding:3px;" class="right">-</td>
			</tr>
			<tr>
