...
<thead>
	<tr>
		<th><h1 style="margin:0;font-size:25px;">BELLEVUE</h1>
			...
			<h4 style="margin:0;">Cash book</h4>
...
$closing_balance=0;
		...
		@foreach($contra_list as $payment)
		<tr>
        ...
        @php $total_expense += $payment['expense_amt'];
              $total_income += $payment['income_amt'];

        @endphp
		@endforeach
        @php	$closing_balance = ((($current_balance->opening_balance) + $total_income) - $total_expense);  @endphp
		@endif
		...
		<td style="font-size:12px;text-align:right;padding-top:10px;border-top: 2px solid #000;"></td>
		<td style="font-size:12px;text-align:right;padding-top:10px;border-top: 2px solid #000;"></td>
		<td style="font-size:12px;text-align:right;padding-top:10px;border-top: 2px solid #000;">{{ $closing_balance }}</td>
	</tr>
	</tbody>
</table>
</body>
