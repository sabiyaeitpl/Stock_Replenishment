...
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li> -->
                                <li class="active">Generate Attendance</li>
                            </ul>
                        </span>
</div>
</div>
		...
		<div class="row">
			...
			@endif
					...
					<div class="card-body card-block">
						<form action="{{url('attendance/add-montly-attendance-data-all')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
							{{ csrf_field() }}
				...
				<div class="card">
					...
					<div class="card-body card-block">
						<div class="payroll-table table-responsive" style="margin:0 auto;overflow-x:scroll;">
							<form action="{{url('attendance/save-montly-attendance-data-all')}}" method="post">
								{{csrf_field()}}
