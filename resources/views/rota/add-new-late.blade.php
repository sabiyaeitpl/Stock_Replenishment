...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">       
            <h5 class="card-title">Late Policy Details</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active">Late Policy Details</li>
			...
			<div class="main-card">
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="{{ url('rota/save-late-policy') }}" method="post" enctype="multipart/form-data">
							...
							<div class="lv-due" style="border:none;">
								...
								<div class="row form-group lv-due-body">
                                    ...
                                    <div class="col-md-3">
										...
										<input id="inputFloatingLabel-shift-description"  name="max_grace" value="" type="number" class="form-control input-border-bottom" required  placeholder="">
									</div>

                                    <div class="col-md-3">
										<label>No. of Days Allow</label>
										<input id="inputFloatingLabel-shift-in-time"  name="no_allow" value="" type="number" class="form-control input-border-bottom" required  placeholder="">
									</div>

                                    <div class="col-md-3">
										<label>No. of Day Salary Deducted</label>
										<input id="inputFloatingLabel-shift-out-time"  name="no_day_red" value="" type="number" class="form-control input-border-bottom" required  placeholder="">
									</div>
