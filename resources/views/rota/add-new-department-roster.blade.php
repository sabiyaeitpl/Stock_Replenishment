...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">       
            <h5 class="card-title">Duty Roster (Department wise)</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active">Duty Roster (Department wise)</li>
		...
		<div class="row">
			<div class="main-card">
				<div class="card">
					<!-- <div class="card-header"><strong class="card-title">Duty Roster (Department wise)</strong></div> -->
					<div class="card-body">

						@include('include.messages')
						<form action="{{ url('rota/save-department-duty') }}" method="post" enctype="multipart/form-data" class="form-horizontal" >
