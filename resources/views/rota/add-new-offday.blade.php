...
<div class="content">
    ...
    <div class="row" style="border:none;">
            <div class="col-md-6">       
            <h5 class="card-title">Day Off Details</h5>      
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active">Day Off Details</li>
            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('rota/save-offday') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="lv-due" style="border:none;">
                                ...
                                <div class="row form-group lv-due-body">
                                    <div class="col-md-3">
                                        ...
                                        <input id="inputFloatingLabel-monday" type="checkbox" name="mon" value="1">
                                        <label for="inputFloatingLabel-monday" class="day-check">Monday</label>
                                    </div>
                                    <div class="col-md-3">

                                        <input id="inputFloatingLabel-Tuesday" type="checkbox" name="tue" value="1">
                                        <label for="inputFloatingLabel-Tuesday" class="day-check">Tuesday</label>
                                    </div>
                                    <div class="col-md-3">

                                        <input id="inputFloatingLabel-Wednesday" type="checkbox" name="wed" value="1">
                                        <label for="inputFloatingLabel-Wednesday" class="day-check">Wednesday</label>
                                    </div>
                                    <div class="col-md-3">

                                        <input id="inputFloatingLabel-Thursday" type="checkbox" name="thu" value="1">
                                        <label for="inputFloatingLabel-Thursday" class="day-check">Thursday</label>
                                    </div>
                                    <div class="col-md-3">

                                        <input id="inputFloatingLabel-Friday" type="checkbox" name="fri" value="1">
                                        <label for="inputFloatingLabel-Friday" class="day-check">Friday</label>
                                    </div>
                                    <div class="col-md-3">

                                        <input id="inputFloatingLabel-Saturday" type="checkbox" name="sat" value="1">
                                        <label for="inputFloatingLabel-Saturday" class="day-check">Saturday</label>
                                    </div>
                                    <div class="col-md-3">

                                        <input id="inputFloatingLabel-Sunday" type="checkbox" name="sun" value="1">
