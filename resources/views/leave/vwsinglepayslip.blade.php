...
body {-webkit-print-color-adjust: exact;}
	...
	.payslip .pay-head h2 {font-size: 22px;color: black;text-align:center;margin:0;}
	.payslip .pay-head h3{text-align:center;margin:0;}
	.payslip .pay-head h4 {font-size: 15px;text-align:center;margin:0;}
	...
	.emp-det tr.part td{padding:5px;text-align:left;font-weight:bold;border-top:none;background:#efefef;}
	.sal-det tr td{padding:7px 10px;text-align:left;}
	.sal-det tr td p{text-align:right;margin:0;}.mon{text-align: center;}.mon h3{color:#0099be;margin:0;font-size:25px;}.mon h4{margin:0; color: black;}
...
<div class="payslip">
	...
	<!------------Salary-details----------------->	
				...
				<tbody>
					...
					<tr>
						<td>VDA</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_vda}}</td>
						<td>VDA</td>
					...
					<tr>
						<td>TIFF ALW.</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_tiff_alw}}</td>
						<td>TIFF ALW.</td>
						<td style="text-align:right;">{{$payroll_rs[0]->emp_actual_tiff_alw}}</td>
						<td>I TAX</td>
						<td style="text-align:right;">{{$payroll_rs[0]->emp_i_tax}}</td>
					</tr>
					<tr>
						<td>OTH ALW</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_others_alw}}</td>
						<td>OTH ALW</td>
					...
					<tr>
						<td>CONV</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_conv}}</td>
						<td>CONV</td>
					...
					<tr>
						<td>MEDICAL</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_medical}}</td>
						<td>MEDICAL</td>
					...
					<tr>
						<td>MISC ALW</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_misc_alw}}</td>
						<td>MISC ALW</td>
					...
					<tr>
						<td>OVER TIME</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_over_time}}</td>
						<td>OVER TIME</td>
					...
					<tr>
						<td>BONUS</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_bouns}}</td>
						<td>BONUS</td>
					...
					<tr>
						<td>LEAVE ENC</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_leave_inc}}</td>
						<td>LEAVE ENC</td>
					...
					<tr>
						<td>HTA</td>
						<td style="text-align:right;">{{$actual_payroll->emp_actual_hta}}</td>
						<td>HTA</td>
					...
					<tr>
						...
						<td rowspan="2" style="text-align:right;">{{$payroll_rs[0]->emp_actual_others_addition}}</td>
						<td rowspan="2">Other </td>
						<td rowspan="2" style="text-align:right;">{{$payroll_rs[0]->other_addition}}</td>
						<td>Income Tax</td>
						<td style="text-align:right;">{{$actual_payroll->emp_income_tax}}</td>
					</tr>
...
<?php $number = $payroll_rs[0]->emp_net_salary;
  ...
  //echo $result . "Rupees  " . $points . " Paise"; ?>
					...
					<tr>
						...
						<td style="font-weight:600;text-align:right;" colspan="4"><span style="float:left;"><?php echo strtoupper($result) . "RUPEES"; ?></span>{{$payroll_rs[0]->emp_net_salary}}</td>
					</tr>
				</tbody>
			</table>
