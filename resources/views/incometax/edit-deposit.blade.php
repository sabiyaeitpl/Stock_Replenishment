            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <form action="{{ url('itax/update-deposit') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" required id="payment_date" name="payment_date" class="form-control" value="{{ $records->payment_date}}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="any" required id="amount" name="amount" class="form-control" value="{{ $records->amount}}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text"  id="challan_no" name="challan_no" class="form-control" value="{{ $records->challan_no}}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text"  id="bsr_code" name="bsr_code" class="form-control" value="{{ $records->bsr_code}}" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <textarea type="text"  id="bank" name="bank" class="form-control" required>{{ $records->bank}}</textarea>
                                    @if ($errors->has('bank'))
