...
<div class="content">
    ...
    <div class="animated fadeIn">
        <div class="row" style="border:none;">
            <div class="col-md-6">
                <h5 class="card-title">View Form 16</h5>
            </div>
            <div class="col-md-6">
                <span class="right-brd" style="padding-right:15x;">
                    <ul class="">
                        <li><a href="#">View Form 16</a></li>
                    </ul>
                </span>
            </div>
        </div>
...
function viewDetails() {
    if ($('#financial_year').val() != null && $('#emp_code').val() != null) {
        window.open("{{url('itax/form-sixteen')}}?p=" + btoa($('#financial_year').val()) + "&f=" + btoa(
            $('#emp_code').val()), '_blank');
    } else {
...
function reset() {
    window.location.href = "{{url('itax/form-sixteen')}}";
}
</script>
@endsection