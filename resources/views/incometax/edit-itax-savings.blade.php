...
<div class="content">
    ...
    <div class="animated fadeIn">
        <div class="row" style="border:none;">
            <div class="col-md-6">
                <h5 class="card-title">Edit Income Tax Savings</h5>
            </div>
            <div class="col-md-6">
                <span class="right-brd" style="padding-right:15x;">
                    <ul class="">
                        ...
                        <li>/</li>
                        <li><a href="#">Edit Income Tax Savings</a></li>
                    </ul>
                </span>
            </div>
        </div>
            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <form action="{{ url('itax/edit-employee-savings') }}" method="post"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="i_tax_type"  id="i_tax_type" class="form-control" required  onchange="getSavingsTypeInfo(this.value);">
                                        ...
                                        <option value='{{ $tax->id }}' @if($tax->id==$itaxsave->i_tax_type) selected @endif>{{ $tax->tax_desc }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="saving_type_id"  id="saving_type_id" class="form-control" required>
                                        <option value="" selected disabled>Select</option>
                                        @foreach($stypes as $styp)
                                        <option value='{{ $styp->id }}' @if($styp->id==$itaxsave->saving_type_id) selected @endif>{{ $styp->saving_type_desc }}</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="any" required id="amount" name="amount"
                                        class="form-control" value="{{$itaxsave->amount}}">
...
$(document).ready(function(){
    fmaxamtload({{$itaxsave->i_tax_type}});
});


function fmaxamtload(taxtype)
{
    $.ajax({
        type:'GET',
