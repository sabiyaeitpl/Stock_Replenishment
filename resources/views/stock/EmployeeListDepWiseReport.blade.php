...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Employee Department Report</h5>
</div>
<div class="col-md-6">
			...
			<div class="main-card">
				<div class="card">
					...
					<div class="card-body card-block">
						<form method="post" action="{{ url('employees/department-export-report') }}" enctype="multipart/form-data" style="width:98%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
							{{ csrf_field() }}
							<div class="row form-group">
								<div class="col-md-10">
									<label for="text-input" class=" form-control-label" style="text-align:right;">Select Department</label>
                                    <div>
                                    <select data-placeholder="Choose Department..." name="department" id="department" class="form-control select2_el" required>
                                        <option value="" selected disabled > Select </option>
                                        @foreach ($monthlist as $month)
                                        <option value="<?php echo $month->emp_department; ?>"><?php echo $month->emp_department; ?></option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('month'))
