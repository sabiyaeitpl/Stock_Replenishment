        ...
        <div id="sf1" class="frm">
          <fieldset>
			...
			<div class="row form-group">
                ...
                <input type="text" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_code;}?>" name="emp_code" class="form-control" readonly="1">
...
<!--			------------------------->
          ...
          <!------------pay-details-------------->
            ...
            <div class="row form-group">
				...
				<label>Class Name  <span>(*)</span></label>
						...
						<option value="{{ $group->id}}" <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_group_name == $group->id) {echo 'selected';}}?>>{{ $group->group_name}}</option>
						@endforeach
    ...
    if ($employee_rs[0]->emp_pay_scale == $payscale->id) {echo 'selected';}
				...
				<input type="number" step="any" id="emp_basic_pay" name="emp_basic_pay" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->basic_pay;}?>" class="form-control" required>
