        ...
        <div class="row">
            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="aply-lv">
                        <a href="{{ url('add-rol') }}" class="btn btn-default" style="float:right;">Add Import Master <i class="fa fa-plus"></i></a>
                        @if(count($sales_rs)>0)
                        <form  method="post" action="{{ url('xls-export-employees') }}" enctype="multipart/form-data" >
                                ...
                                <form  method="post" action="{{ url('xls-export-employee-only') }}" enctype="multipart/form-data" >
											...
											<button data-toggle="tooltip" data-placement="bottom" title="Download Excel" class="btn btn-default" style="background:none !important;padding: 10px 15px;margin-top: -30px;float:right;margin-right: 15px;" type="submit">Rol Data Only</button>
												</form>
                        @endif
                    </div>
                    </div>
