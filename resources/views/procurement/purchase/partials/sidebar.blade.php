            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
					...
					<!-- <li class="menu-item-has-children dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="{{ asset('images/branch.png') }}" alt="" />Purchase Order</a> -->
                        <li><a href="{{ url('procurement/purchase/PO-item') }}"><img src="{{ asset('images/branch.png') }}" alt="" /> Purchase Order</a></li>
                    <li><a href="{{ url('procurement/purchase/get-issued-po-item') }}"><img src="{{ asset('images/daily-att.png') }}" alt="" /> View Issued Purchase Order</a></li>
