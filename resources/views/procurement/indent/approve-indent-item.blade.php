                    ...
                    <div class="main-card">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title" style="font-size:21px; font-weight: 100;"><img src="{{asset('images/product.png')}}" alt="">Approve Indent Item</strong>
                            </div>
							<!-- <div class="aply-lv" style="padding-right: 36px;">
								<a href="{{ url('procurement/indent/add-new-indent-item') }}" class="btn btn-default">Add Requisition<i class="fa fa-plus"></i></a>
							</div> -->
                            <div class="card-body">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
											...
											<th>Indent Made Date</th>
                                            <th>Indent Required Date</th>
                                            <th>Status</th>
											<th>Action</th>
                                        </tr>
                                    </thead>
									...
									@foreach($indent_item_rs as $indent_item)
                                        ...
                                        <tr>
											...
											<td>
                                                <a class="btn btn-round btn-info" href='{{url("procurement/indent/view-indent-item/$indent_item->indent_no")}}'><i class="ti-eye" style="color: #fff;" aria-hidden="true"></i></a>
