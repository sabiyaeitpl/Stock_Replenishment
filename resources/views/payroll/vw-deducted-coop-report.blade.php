...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Monthly Deducted Cooperative Report</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li class="active">Monthly Deducted Cooperative Report</li>
                            </ul>
                        </span>
</div>
</div>
			...
			<div class="main-card">
				<div class="card">
					...
					<div class="card-body card-block">
						<form action="{{url('payroll/vw-deducted-coop-report')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
							{{ csrf_field() }}
				...
				<div class="card">
					...
					<div class="card-header" style="background:#fff;">
						...
						<div style="display:inline-flex;float:right;" class="card-icon">
							<form  method="post" action="{{ url('payroll/xls-export-deducted-coop-report') }}" enctype="multipart/form-data" >
							...
							<form  method="post" action="{{ url('payroll/prn-deducted-coop-report') }}" enctype="multipart/form-data" target="_blank">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
