...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Monthly Non Deducted Cooperative Report</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li class="active">Monthly Non Deducted Cooperative Report</li>
                            </ul>
                        </span>
</div>
</div>
			...
			<div class="main-card">
				<div class="card">
					...
					<div class="card-body card-block">
						<form action="{{url('payroll/vw-non-deducted-coop-report')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
							{{ csrf_field() }}
				...
				<div class="card">
					...
					<div class="card-header" style="background:#fff;">
						...
						<div style="display:inline-flex;float:right;" class="card-icon">
										<form  method="post" action="{{ url('payroll/xls-export-non-deducted-coop-report') }}" enctype="multipart/form-data" >
											...
											<button data-toggle="tooltip" data-placement="bottom" title="Download Excel" class="btn btn-default" style="background:none !important;" type="submit"><img  style="width: 35px;" src="{{ asset('img/excel-dnld.png')}}"></button>
												...
												<form  method="post" action="{{ url('payroll/prn-non-deducted-coop-report') }}" enctype="multipart/form-data" target="_blank">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
