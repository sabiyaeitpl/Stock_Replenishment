...
?>
					<h4>Income Tax Report from <?php echo $from_date . ' - ' . $fromdate[1]; ?> to <?php echo $to_date . ' - ' . $todate[1]; ?> </h4>
...
$total_calculation = 0;
$i = 1;
if (!empty($employee_ptax)) {foreach ($employee_ptax as $key => $val) {?>
					<tr class="part">
						...
						<td style="text-align: center;"><?php echo $val['emp_pan_no']; ?></td>
						<td style="text-align: center;"><?php echo $val['emp_income_tax']; ?></td>
						<!-- <td style="text-align: center;"><?php //echo $val['emp_cess']; ?></td> -->
						<td style="text-align:right;"><?php
//$deduction_total = $val['emp_income_tax'] + $val['emp_cess'];
    $deduction_total = $val['emp_income_tax'];
    $total_calculation += $deduction_total;
    echo $deduction_total;?></td>
					</tr>
				<?php $i++;}}?>
					<tr>
...
//echo $result . "Rupees  " . $points . " Paise"; ?>
				<td style="font-weight:600;" colspan="6">Total in words: RUPEES <?php echo strtoupper($result); ?>  </td>
