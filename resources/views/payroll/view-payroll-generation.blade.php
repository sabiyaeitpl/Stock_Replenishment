  ...
  <div class="animated fadeIn">
    ...
    <div class="row">
      ...
      <div class="main-card">
        ...
        <div class="card">
          <div class="card-header"> <div class="aply-lv"><a href="{{url('payroll/add-payroll-generation')}}" class="btn btn-default">Generate Payroll <i class="fa fa-plus"></i></a></div></div>
          ...
          <div class="card-body card-block">
						<form action="{{url('payroll/vw-payroll-generation')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
							{{ csrf_field() }}
