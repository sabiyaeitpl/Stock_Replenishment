...
<div class="content">
  ...
  <div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Voucher (Payroll)</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li>/</li>
                                <li><a href="#">Voucher (Payroll)</a></li>
                            </ul>
                        </span>
</div>
</div>
    ...
    <div class="row">
      ...
      <div class="main-card">
        ...
        <div class="card">
          <div class="card-header"> <div class="aply-lv"><a href="{{url('payroll/voucher-payroll-generation')}}" class="btn btn-default">Generate Voucher (Payroll) <i class="fa fa-plus"></i></a></div></div>
