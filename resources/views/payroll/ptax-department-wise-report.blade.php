...
body {-webkit-print-color-adjust: exact;}
	...
	.sal-det tr th {background: #bbb8b8;padding: 5px 10px;border-bottom: none;color: #000;text-align:center;}
...
$dt = $month_yr;
    ...
    ?>
					<h4>Professional Tax for the month of <?php echo $paymonth . ' - ' . $dtar[1]; ?></h4>
				<?php }?>
				</div>
			</td>
...
if (!empty($employee_ptax)) {foreach ($employee_ptax as $val) {?>
					<tr class="part">
						...
						<td style="text-align: center;"><?php echo $val->employee_id; ?></td>
...
//$tax_tot=$tax_tot+$val->emp_prof_tax;
    $total_calculation += $val->emp_prof_tax;
    echo $val->emp_prof_tax ;
	?>
						</td>
					</tr>
				<?php $i++;}}?>
...
//echo $result . "Rupees  " . $points . " Paise"; ?>
						...
						<td style="font-weight:600;text-align:right;" colspan="2"><?php echo $total_calculation; ?></td>
					</tr>
