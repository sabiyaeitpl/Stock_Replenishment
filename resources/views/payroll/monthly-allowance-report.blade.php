...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Monthly Allowance Entry Report</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li class="active">Monthly Allowance Entry Report</li>
                            </ul>
                        </span>
</div>
</div>
			...
			<div class="main-card">
				<div class="card">
					...
					<div class="card-body card-block">
						<form action="{{url('payroll/monthly-allowance-entry-report')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
							{{ csrf_field() }}
				...
				<div class="card">
					...
					<div class="card-header">
						<!-- <strong class="card-title">Department Summary</strong> -->
										...
										<form  method="post" action="{{ url('payroll/xls-export-monthly-allowance-entry-report') }}" enctype="multipart/form-data" >
								...
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<tbody>
                                        ...
                                        <tr>
											...
											<td>{{$record->no_days_tiffalw}}</td>
											<td>{{$record->pay_structure_tiff_alw}}</td>
											<td>{{$record->tiffin_alw}}</td>
											<td>{{$record->no_days_convalw}}</td>
											<td>{{$record->pay_structure_conv_alw}}</td>
											<td>{{$record->convence_alw}}</td>
											<td>{{$record->no_days_miscalw}}</td>
											<td>{{$record->pay_structure_misc_alw}}</td>
											<td>{{$record->misc_alw}}</td>
											<td>{{$record->extra_misc_alw}}</td>
                                        </tr>
                                        @endforeach
									</tbody>
									<tfoot>
										<tr>
											...
											<td>
                                                <div style="font-weight:700;">{{$total_tiff_days}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_ent_tiff}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_tiff}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_conv_days}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_ent_conv}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_conv}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_mics_days}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_ent_mics}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_mics}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_extra_mics}}</div>
                                            </td>
