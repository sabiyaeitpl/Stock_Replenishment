...
@section('content')
  	...
  	<div class="content">
		...
		<div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Income Tax Statement Employeewise</h5>
</div>
<div class="col-md-6">
	...
	<ul class="">
		...
		<li>/</li>
		<li class="active">Income Tax Statement Employeewise</li>
	      ...
	      <div class="row">
	        <div class="main-card">
	          <div class="card">
	            <!-- <div class="card-header"><strong>Income Tax Statement Employeewise</strong></div> -->
	            ...
	            <form action="" method="post" style="width: 100%;margin: 0 auto;" target="_blank">
					...
					<label>Select Employee</label>
						<select data-placeholder="Choose Employee..." name="emp_code" class="form-control select2_el" required>
							...
							<option value="<?php echo $employee->emp_code; ?>" @if(isset($employee_new) && $employee_new==$employee->emp_code) selected @endif><?php echo $employee->emp_fname . " " . $employee->emp_mname . " " . $employee->emp_lname . " (" . $employee->emp_code . ") "; ?></option>
							<?php }?>
                        </select>
					</div>
