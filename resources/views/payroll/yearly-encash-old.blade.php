                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <div class="payroll-table table-responsive"
                            ...
                            <form action="{{url('payroll/update-encashment-all')}}" method="post" id="myForm">
                                {{csrf_field()}}
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="total_leaveenc" style="font-weight:700;"></div></td>
											<td><div class="total_hta" style="font-weight:700;"></div></td>
