...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Monthly Coop Entry Report</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li class="active">Monthly Coop Entry Report</li>
                            </ul>
                        </span>
</div>
</div>
			...
			<div class="main-card">
				<div class="card">
					...
					<div class="card-body card-block">
						<form action="{{url('payroll/monthly-coop-entry-report')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
							{{ csrf_field() }}
				...
				<div class="card">
					...
					<div class="card-header">
						<!-- <strong class="card-title">Department Summary</strong> -->
										...
										<form  method="post" action="{{ url('payroll/xls-export-monthly-coop-entry-report') }}" enctype="multipart/form-data" >
								...
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									<thead style="text-align:center;vertical-align:middle;">
										<tr>
											...
											<th style="width:15%;">Insurance Premium Deduction</th>
											
											<th style="width:15%;">Cooperative Deduction</th>
											
											<th style="width:15%;">Miscellaneous Deduction</th>
									...
									<tbody>
                                        ...
                                        <tr>
											...
											<td>{{$record->insurance_prem}}</td>
											
											<td>{{$record->coop_amount}}</td>
											
											<td>{{$record->misc_ded}}</td>
