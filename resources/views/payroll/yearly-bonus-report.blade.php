...
<div class="content">
    ...
    <div class="animated fadeIn">
        <div class="row" style="border:none;">
            <div class="col-md-6">
                <h5 class="card-title">Yearly Bonus Entry Report</h5>
            </div>
            <div class="col-md-6">
                ...
                <span class="right-brd" style="padding-right:15x;">
                    <ul class="">
                        ...
                        <li class="active">Yearly Bonus Entry Report</li>
                    </ul>
                </span>
            </div>
        </div>
            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{url('payroll/yearly-bonus-entry-report')}}" method="post"
                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="total_deduction" style="font-weight:700;">{{$total_deduction}}
                                            </div>
                                        </td>
