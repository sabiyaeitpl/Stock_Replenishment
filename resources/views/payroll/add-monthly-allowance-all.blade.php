...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Generate Monthly Allowances for All Employee</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li>/</li>
                                <li><a href="#">Monthly Allowances</a></li>
								<li>/</li>
                                <li class="active">Generate Monthly Allowances for All Employee</li>
                            </ul>
                        </span>
</div>
</div>
