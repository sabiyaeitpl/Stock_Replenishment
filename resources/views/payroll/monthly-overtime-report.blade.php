...
<div class="content">
	...
	<div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Monthly Overtime Entry Report</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
                                ...
                                <li class="active">Monthly Overtime Entry Report</li>
                            </ul>
                        </span>
</div>
</div>
			...
			<div class="main-card">
				<div class="card">
					...
					<div class="card-body card-block">
						<form action="{{url('payroll/monthly-overtime-entry-report')}}" method="post" enctype="multipart/form-data" style="width:50%;margin:0 auto;padding: 18px 20px 1px;background: #ecebeb;">
							{{ csrf_field() }}
				...
				<div class="card">
					...
					<div class="card-header">
						<!-- <strong class="card-title">Department Summary</strong> -->
										...
										<form  method="post" action="{{ url('payroll/xls-export-monthly-overtime-entry-report') }}" enctype="multipart/form-data" >
								...
								<table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<tbody>
                                        ...
                                        <tr>
											...
											<td>{{$record->pay_structure_basic}}</td>
											<td>{{$record->last_month_ot_hrs}}</td>
											<td>{{$record->current_month_ot_hrs}}</td>
											<td>{{$record->last_month_ot}}</td>
											<td>{{$record->curr_month_ot}}</td>
											<td>{{$record->ot_alws}}</td>
                                        </tr>
                                        @endforeach
									</tbody>
									<tfoot>
										<tr>
											...
											<td>
                                                <div style="font-weight:700;">{{$total_lm_ot_hrs}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_cm_ot_hrs}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_lm_ot}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_cm_ot}}</div>
                                            </td>
											<td>
                                                <div style="font-weight:700;">{{$total_ot}}</div>
                                            </td>
