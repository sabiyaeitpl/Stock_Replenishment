            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-success" style="text-align:center;color: #ff0000;"><i
                                class="fa fa-check" aria-hidden="true"></i><em> {{ Session::get('message') }}</em></div>
                        @endif
                        <form action="{{ url('role/update-user-config') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="lv-due" style="border:none;">
                                ...
                                <div class="row form-group lv-due-body">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" id="emp_name" name="name"
